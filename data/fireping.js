  ...
  getInfo() {
    return {
      ...
      blocks: [
        ...
        { opcode: "sendData", blockType: "command", text: "send data [DATA] to path [PATH] guest? [GUEST]", arguments: { DATA: { type: "string", defaultValue: '{"key":"value"}' }, PATH: { type: "string", defaultValue: "user/local" }, GUEST: { type: "Boolean", defaultValue: false } } },
        { opcode: "changeData", blockType: "command", text: "update data [DATA] at path [PATH] guest? [GUEST]", arguments: { DATA: { type: "string", defaultValue: '{"key":"value"}' }, PATH: { type: "string", defaultValue: "user/local" }, GUEST: { type: "Boolean", defaultValue: false } } },
